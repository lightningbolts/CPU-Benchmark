...
if __name__ == "__main__":
    ...
    print(
        f"Efficiency for {digits} digits is {round((execution_time_single_core / execution_time_multi_core) / processes, 2)}")
    print(
        f"CPU utilization for {digits} digits is {round(((execution_time_single_core / execution_time_multi_core) / processes) * 100, 2)}%")
