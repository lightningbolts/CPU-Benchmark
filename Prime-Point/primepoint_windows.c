...
{
    int64_t digits_point = 150000000000L;
...
#include <sys/sysctl.h>
    ...
    double execution_time_multi_core = (execution_time_multi_core_prime + execution_time_multi_core_point) / 2;

    // Average the digits
    int64_t digits = (digits_prime + digits_point) / 2;
    ...
    printf("Single core score: %" PRId64 "\n", score_single_core);
    printf("Multi core score: %" PRId64 "\n", score_multi_core);
