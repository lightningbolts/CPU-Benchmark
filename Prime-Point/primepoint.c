...
void BenchmarkToJson(struct benchmark benchmark, char *jsonString)
{
    sprintf(jsonString, "{"
                        "\"cpu_model\":\"%s\","
                        "\"os_info\":\"%s\","
...
double calculate_execution_time_point(int64_t digits, int num_threads)
{
...
{
    int64_t digits_point = 50000000000L;
...
#include <sys/sysctl.h>
    ...
    double execution_time_single_core_point = calculate_execution_time_point(digits_point, 1);
    double execution_time_single_core_prime = calculate_execution_time_prime(digits_prime, 1);
    double execution_time_multi_core_point = calculate_execution_time_point(digits_point, processes);
    double execution_time_multi_core_prime = calculate_execution_time_prime(digits_prime, processes);
    int64_t score_single_core_point = calculate_score_point(digits_point, execution_time_single_core_point);
    ...
    // Average the scores
    int64_t score_single_core = (score_single_core_point + score_single_core_prime) / 2;
    int64_t score_multi_core = (score_multi_core_point + 2 * score_multi_core_prime) / 3;

    // Average the execution times
    double execution_time_single_core = (execution_time_single_core_point + execution_time_single_core_prime) / 2;
    double execution_time_multi_core = (execution_time_multi_core_point + execution_time_multi_core_prime) / 2;

    // Average the digits
    int64_t digits = (digits_point + digits_prime) / 2;
    ...
    printf("Execution time single core: %lf\n", execution_time_single_core);
    printf("Execution time multi core: %lf\n", execution_time_multi_core);
    ...
    BenchmarkToJson(benchmark, jsonString);
